from python_snippet import get_file_name, get_raw_url, print_code
...
def test_get_raw_url():
    ...
    assert (
        raw_url
        == "https://raw.githubusercontent.com/khuyentran1401/Python-data-science-code-snippet/master/code_snippets/python/multiples_of_a_number.py"
    )
